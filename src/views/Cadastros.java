...
public class Cadastros extends javax.swing.JFrame {
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtNascimentoAluno, javax.swing.GroupLayout.DEFAULT_SIZE, 433, Short.MAX_VALUE)
                            .addComponent(cbTurmaAluno, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(btnSalvarAluno, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addGap(44, 44, 44)
    ...
    private void btnSalvarMatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarMatActionPerformed
        try {
            ...
            + "'"+this.txtNomeMat.getText()+"', '"+this.cbProfessorMat.getSelectedIndex()+"')";

            Main.Connection().FastQuery(sql);
            JOptionPane.showMessageDialog(null, "Matéria adicionadacom sucesso!");
        }
        catch(Exception e) {
            System.out.println(e.getMessage());
        }        
